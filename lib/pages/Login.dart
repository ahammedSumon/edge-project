                ...
                Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        InputField(context, "Enter your email here",
                        ...
                        InputField(context, "Enter your password here", Icons.lock, true,
                            _passwordController)
                      ],
                    )),
                SizedBox(height: 50),
                      ...
                      if (form!.validate()) {
                        ...
                        try {
                          User user = (await controller.getLogin(
                              _emailController.text, _passwordController.text!)) as User;
                          if (user.id != -1) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Unregistered user!')),
                            );
                          }
                        } catch (e) {
                          ScaffoldMessenger.of(context).showSnackBar(
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: TextFormField(
          ...
          onSaved: (value) {
            if (hint == 'Type your e-mail') {
              _email = value;
            } else if (hint == 'Type your password') {
              _password = value;
            }
          },
        ),
